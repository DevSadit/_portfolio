          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <div
                  className="animate-pulse bg-[#111111] rounded-lg p-8 border border-gray-800 w-full"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-xl mx-auto">
              {
                "Whether it’s a collaboration, a project idea, or just a quick chat, I’m always open to new connections"
              }
            </p>
          </div>
            ...
            <div className="md:col-span-1 flex flex-col">
              ...
              <div className="bg-[#111111] rounded-lg p-6 border border-gray-800 hover:border-[#F9004D] transition-all duration-300">
                ...
                <div className="flex justify-between mt-3">
                  ...
                  <Link
                    target="_blank"
                    href="http://www.facebook.com/shahmiraj.ehesan/"
                    className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                  ...
                  <Link
                    target="_blank"
                    href="https://www.linkedin.com/in/shehesan/"
                    className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Link
                    target="_blank"
                    href="https://github.com/DevSadit"
                    className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Link
                    target="_blank"
                    href="https://www.instagram.com/sadit_90/"
                    className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
