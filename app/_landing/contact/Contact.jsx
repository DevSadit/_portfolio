...
export default function ContactPage() {
  ...
  return (
    <div id="contact" className="min-h-screen bg-[#0A0A0A] mb-10">
            ...
            <div className="md:col-span-1 flex flex-col">
              <div className="bg-[#111111] rounded-lg p-6 border border-gray-800 mb-4 hover:border-[#F9004D] transition-all duration-300">
                ...
                <div className="flex items-center group">
                  <p className="text-gray-400 group-hover:text-gray-300 transition-colors">dev.ehesan@gmail.com</p>
                  <button 
                    onClick={() => {
                      navigator.clipboard.writeText("dev.ehesan@gmail.com");
                      document.getElementById("copy-toast").classList.remove("hidden");
                      setTimeout(() => {
                        document.getElementById("copy-toast").classList.add("hidden");
                      }, 2000);
                    }}
                    className="ml-2 text-gray-400 hover:text-[#F9004D] transition-all duration-300 p-1 rounded-full hover:bg-gray-800"
                    title="Copy email"
                  >
              ...
              <div className="bg-[#111111] rounded-lg p-6 border border-gray-800 hover:border-[#F9004D] transition-all duration-300">
                ...
                <div className="flex justify-between mt-3">
                  {/* Facebook */}
                  <Link target="_blank" href="http://www.facebook.com/shahmiraj.ehesan/" className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                    </svg>
                  </Link>
                  {/* LinkedIn */}
                  <Link href="#" className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                    </svg>
                  </Link>
                  {/* GitHub */}
                  <Link target="_blank" href="https://github.com/DevSadit" className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Instagram */}
                  <Link target="_blank" href="https://www.instagram.com/sadit_90/" className="text-gray-400 hover:text-[#F9004D] transition-all duration-300 transform hover:-translate-y-1 p-2 rounded-full hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div id="copy-toast" className="toast toast-top toast-end hidden">
        <div className="alert alert-success bg-[#111111] border border-[#F9004D] text-white">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#F9004D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
