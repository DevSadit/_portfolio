...
export default function TechGrid() {
  ...
  const techList = [
    ...
    },
    {
      ...
      color: "from-green-500 to-green-600",
      image: "/Tech_svgs/python.svg",
    },
    {
      name: "NumPy",
      category: "ML Preprocessing",
      color: "from-blue-500 to-cyan-600",
      image: "/Tech_svgs/numpy.svg",
    },
    {
      name: "Pandas",
      category: "ML Preprocessing",
      color: "from-purple-500 to-indigo-600",
      image: "/Tech_svgs/pandas.svg",
    },
  ];
  ...
  const mlPreprocessingTech = techList.filter(
    (tech) => tech.category === "ML Preprocessing",
  );
  ...
  return (
    <div className="h-full flex flex-col justify-center space-y-4">
      ...
      {renderTechSection("Version Control", versionControlTech)}
      {renderTechSection("Deployment", deploymentTech)}
      {renderTechSection("Machine Learning Preprocessing", mlPreprocessingTech)}
    </div>
  );
}
